...
publish-message:
	gcloud pubsub topics publish send-email --message="{\"from_address\":\"server@sandboxe4caaed5b28d4847baef2e43b7d1e36c.mailgun.org\",\"to_address\":[\"ben@drolet.cloud\"],\"subject\":\"Test Publish\",\"text\":\"Help I am stuck in the server\"}"
